...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $("#frm_karyawan").find($("form")).submit(function(e) {
            e.preventDefault();
            let no_ktp = inputan.find($("input[name='NoKTP']")).val();
            let no_bpjs = inputan.find($("input[name='NoBPJSKes']")).val();
            let nama_lengkap = inputan.find($("input[name='NamaLengkap']")).val();
            let tempat_lahir = inputan.find($("input[name='TempatLahir']")).val();
